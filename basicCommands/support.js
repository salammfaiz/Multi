...
module.exports = {
    ...
    execute(message, args) {
        const supportServerLink = "https://discord.gg/united-city";
      const githubLink = "https://github.com/salammfaiz";
      const replitLink = "https://replit.com/@salammfaiz";
